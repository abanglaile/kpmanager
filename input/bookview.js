...
import { AddKpPage } from './KpFormInput.js';
...
class EditableCell extends React.Component {
        ...
        class ViewEdit extends React.Component {
                constructor(props) {
                    super(props);
                    this.state = { data: [], isedit: [] ,current: '512'};
                    this.columns = [{
                        title: '知识点id',
                        dataIndex: 'kpid',
                        width: '10%',
                    ...
                    // var url = 'http://10.251.221.175/server/klmanager/getChapterKp?chapter_id='+this.state.current;
                    console.log('url:'+url);                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          
                    NetUtil.get(url, '', (results) => {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            var rowdata = { key: data[i].kpid, kpid: data[i].kpid, kpindex: data[i].kpindex, kpname: data[i].kpname, description: data[i].description };
                    ...
                    var urlMenu = urlip+'getBookChapter?course_id=2';
